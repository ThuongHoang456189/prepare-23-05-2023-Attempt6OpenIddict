...
public static class Attempt6OpenIddictEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE Attempt6OpenIddictModuleExtensionConfigurator CLASS (in the Domain.Shared project)
