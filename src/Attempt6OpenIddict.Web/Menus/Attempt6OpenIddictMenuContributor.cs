...
namespace Attempt6OpenIddict.Web.Menus;

public class Attempt6OpenIddictMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public Attempt6OpenIddictMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<Attempt6OpenIddictResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                Attempt6OpenIddictMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
